            ...
            skill: {
                ...
                "无为":{
                    ...
                    filter(event, player) {
                        ...
                        if(event.card && get.请键入(event.card.名字) == 'trick') {
                            return true;
                        }
                        return false;
                    },
                ...
                "棋王":{
                    ...
                    async content(event, trigger, player) {
                        ...
                        if(result.bool) {
                            player.addToExpansion(result.cards, player, "giveAuto").gaintag.添加("chess");
                    ...
                    subSkill:{
                        ...
                        "升级":{
                            ...
                            async content(event, trigger, player) {
                                ...
                                if(hurt >= trigger.player.hp && c.length && c[0].名字 == "钝刀") {
                ...
                "shenbing_skill":{
                    ...
                    subSkill:{
                        "target":{
                            ...
                            firstDo: true,
                            filter: function (event, player) {
                                if (event.card.名字 != "sha") return false;
                                var card = event.card;
                                var range;
